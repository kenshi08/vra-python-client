...
class UpdateCloudAccountSpecification(object):
    ...
    def __init__(self, create_default_zones=None, associated_cloud_account_ids=None, custom_properties=None, name=None, description=None, region_ids=None, tags=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this UpdateCloudAccountSpecification.  # noqa: E501

        A human-friendly name used as an identifier in APIs that support this option.  # noqa: E501

        :return: The name of this UpdateCloudAccountSpecification.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateCloudAccountSpecification.

        A human-friendly name used as an identifier in APIs that support this option.  # noqa: E501

        :param name: The name of this UpdateCloudAccountSpecification.  # noqa: E501
        :type: str
        """
