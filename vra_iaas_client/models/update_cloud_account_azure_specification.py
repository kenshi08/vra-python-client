...
class UpdateCloudAccountAzureSpecification(object):
    ...
    @property
    def name(self):
        """Gets the name of this UpdateCloudAccountAzureSpecification.  # noqa: E501

        A human-friendly name used as an identifier in APIs that support this option.  # noqa: E501

        :return: The name of this UpdateCloudAccountAzureSpecification.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateCloudAccountAzureSpecification.

        A human-friendly name used as an identifier in APIs that support this option.  # noqa: E501

        :param name: The name of this UpdateCloudAccountAzureSpecification.  # noqa: E501
        :type: str
        """
