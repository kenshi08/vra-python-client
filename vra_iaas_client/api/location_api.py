...
class LocationApi(object):
    ...
    def get_computes(self, id, **kwargs):  # noqa: E501
        """Get computes  # noqa: E501

        Get zone's computes by given zone ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_computes(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: The ID of the zone. (required)
        :param str api_version: The version of the API in yyyy-MM-dd format (UTC). For versioning information refer to /iaas/api/about
        :return: FabricComputeResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_computes_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_computes_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_computes_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get computes  # noqa: E501

        Get zone's computes by given zone ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_computes_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_computes`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iaas/api/zones/{id}/computes', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='FabricComputeResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_zone(self, id, body, **kwargs):  # noqa: E501
        """Update zone  # noqa: E501

        Update zone  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_zone(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_zone_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_zone_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update_zone_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update zone  # noqa: E501

        Update zone  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_zone_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
