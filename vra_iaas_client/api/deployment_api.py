...
class DeploymentApi(object):
    ...
    def create_deployment(self, body, **kwargs):  # noqa: E501
        ...
        :param DeploymentSpecification body: Deployment specification instance (required)
    ...
    def delete_deployment_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iaas/api/deployments/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_deployments(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_deployments_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_single_deployment(self, id, **kwargs):  # noqa: E501
        """Get a single deployment  # noqa: E501

        Get a single deployment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_single_deployment(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_single_deployment_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_single_deployment_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_single_deployment_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a single deployment  # noqa: E501

        Get a single deployment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_single_deployment_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_single_deployment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_single_deployment`")  # noqa: E501
